...
ggsave("Plots/mozzies.jpg", plot = mozzie_plot, width = 9, height = 12)
...
print(mean(SF$match_percent))
print(sd(SF$match_percent))
print(mean(DF$match_percent))
print(sd(DF$match_percent))
